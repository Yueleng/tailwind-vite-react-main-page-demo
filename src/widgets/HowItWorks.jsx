...
function HowItWorks() {
  return (
    <div>
      <SectionHeading
        title="Lorem ipsum"
        subTitle="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc vitae malesuada ligula. Nullam consectetur vehicula turpis, nec rutrum nulla placerat vel."
      />
      <div className="mt-14 grid grid-cols-2 md:grid-cols-3 gap-6">
        {[1, 2, 3, 4, 5, 6].map((v) => (
          <div key={v} className="grid justify-items-center gap-y-2">
            ...
            <p className="text-xl font-bold">Nunc cursus</p>
            <p className="text-gray-500">
              Nunc cursus lectus nec mauris condimentum finibus. Morbi tempor
              elit massa, et fermentum nisi dignissim sed. Cras luctus tristique
              quam,
            </p>
          </div>
        ))}
