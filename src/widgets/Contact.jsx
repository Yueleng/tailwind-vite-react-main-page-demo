    ...
    <div className="bg-black md:w-4/5 mx-auto relative overflow-hidden">
      <div className="w-full py-16 px-12">
        <h2 className="text-3xl text-white font-bold">
          Suspendisse nec erat mi.
        </h2>
        <p className="text-lg text-white mt-2 mb-6">
          Vestibulum ante ipsum primis in faucibus orci luctus et ultrices
          posuere cubilia curae; Proin laoreet urna egestas magna faucibus
          elementum. Donec ut erat massa. Phasellus tempus orci arcu, at
          fringilla arcu ornare venenatis.
        </p>
        <div className="flex flex-col items-start md:flex-row md:items-stretch gap-4">
          <input
            type="text"
            name=""
            id=""
        ...
        <p className="text-sm text-zinc-400 mt-3">
          Aenean lacinia molestie libero, et facilisis purus elementum a.
        </p>
      </div>
