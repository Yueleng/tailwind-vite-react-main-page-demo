...
function Footer() {
  return (
    <footer className="grid gap-8 text-gray-500 mx-auto mt-32 md:gap-0 md:w-4/5 md:grid-cols-5">
      <div>
      ...
      <div className="col-span-full mt-12 border-t py-9 flex flex-col justify-between md:flex-row">
        <p>
          由{" "}
